...
<head>
  ...
  <meta name="description" content="Portfolio Mahasiswa Teknik Informatika — pastel pink & white, modern, responsive." />
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .bg{position:fixed;inset:0;z-index:-2;overflow:hidden;background:radial-gradient(1200px 800px at 10% -10%, rgba(255,191,215,.45), transparent 60%),radial-gradient(1000px 700px at 90% 10%, rgba(253,236,243,.8), transparent 60%),linear-gradient(180deg, var(--pink-50), var(--white));animation:bgShift 18s ease-in-out infinite alternate;}
